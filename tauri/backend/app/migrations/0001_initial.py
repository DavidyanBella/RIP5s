# Generated by Django 4.2.7 on 2025-01-06 11:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('character', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.character')),
            ],
            options={
                'verbose_name': 'м-м',
        ...
        migrations.AddConstraint(
            model_name='characterartwork',
            constraint=models.UniqueConstraint(fields=('character', 'artwork'), name='character_artwork_constraint'),
        ),
    ]
